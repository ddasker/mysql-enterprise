...
3.  FTP workshop files 
    ...
    **![#00cc00](https://via.placeholder.com/15/00cc00/000000?text=+) shell>**
    ```
    <copy>sudo wget https://objectstorage.us-ashburn-1.oraclecloud.com/p/4UUFl-vfbEkjacMSdMd_90LLyRWkXsKgYXzzGC2m2e3LU-AaUjigQAwiZ-eLjDo9/n/idazzjlcjqzj/b/bucket-20230109-1614-Security_Workshop_01252023/o/workshop.tar.gz</copy>
    ```
